...
- [v0.3.0](v0.3.0/README.md) — accepted local headless/library-first candidate with checksummed
  core/extras/migration/sample evidence; publication remains pending separate authorization.
